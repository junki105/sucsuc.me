...
本サービスでは、登録ユーザーへ売上の振込をStripeに委託しています。[Stripe Connect](https://stripe.com/ja-hk/connect)を利用し、銀行情報を管理しています。  
銀行情報の取り扱いに関しては[Stripeのプライバシーポリシー](https://stripe.com/ja-hk/privacy)が適用されます。
...
本サービスでは、決済をStripeに委託しています。クレジットカード情報の取り扱いに関しては[Stripeのプライバシーポリシー](https://stripe.com/ja-hk/privacy)が適用されます。
...
本ポリシーに関するお問い合わせは、下記のボタンから問い合わせページにてお願いいたします。