...
本サービスでは利用者がプログラミングをサポートするサービスを販売することができます。「サービス」を利用する場合、料金を支払う利用者（以下「購入者」といいます。）が設定した金額をサービスの販売価格とみなします。

本サービスでは、決済およびクレジットカード情報の管理をStripeに委託しています。コンテンツの購入者は[Stripeの利用規約](https://stripe.com/ja-hk/connect-account/legal)に同意したものとみなします。

本サービスでサービスを販売する利用者（以下「販売者」といいます。）は、運営者が表示金額から所定の手数料を徴収することに同意したものとみなします。

- Stripeが徴収する手数料（決済手数料）：**[表示価格の3.4% + HK$2.35](https://stripe.com/en-hk/pricing)**  
  (日本円から香港ドルへの両替はStripeが規定した決済時のレートになります)
- 運営者が徴収する手数料（プラットフォーム利用料）：表示金額から**8%**
- 振込手数料：振込申請**1回あたり¥350**

決済手数料およびプラットフォーム利用料を除いた未振込の売上金額が¥1,000以上の場合に、販売者は振込申請を行うことができます。

販売者は振込を受けるためには、サービス上で[Stripe Connect](https://stripe.com/ja-hk/connect)を利用して振込先の銀行口座を登録する必要があります。振込先には香港内、または日本国内の銀行口座を指定することができます。


## 第7条（返金）

サービスの提供という特性上、購入者は一度支払いを行った料金に関して、返金を受けることができません。

ただし、サービスが本規約に明らかに違反している、サービスが提供されない。あるいは購入者を欺く悪質な内容であると運営者が判断した場合、運営者は販売者の許可を得ることなく返金の処理、請求を行うことがあります。
...
利用者は運営者に問い合わせることで登録されたアカウントを削除（退会）することができます。また、利用者が本規約に違反した場合、運営者は事前の通知なく、アカウントに関わるデータを削除し、登録を抹消できるものとします。
...
本規約の解釈にあたっては，香港法を準拠法とします。本サービスに関して紛争が生じた場合には、当社の本店所在地を管轄する裁判所を専属的合意管轄とします。
